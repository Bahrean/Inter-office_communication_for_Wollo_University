...
<div>
    <h4 class="mb-3 mb-md-0">Welcome to Department Head Dashboard Mr. <span style="color: rgb(255, 255, 0);font-size: 25px;">{{$profileData->name}}</span></h4>
</div>
    ...
    <div class="card-body">
        ...
        <a href="javascript:;" class="d-flex align-items-center border-bottom pb-3">
            ...
            <div class="d-flex justify-content-between">
                <h6 class="text-body mb-2">Abrham Ayanew</h6>
