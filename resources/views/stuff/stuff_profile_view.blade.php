  ...
  <div class="d-none d-md-block col-md-4 col-xl-4 left-wrapper">
    <div class="card rounded">
      <div class="card-body">
        ...
        <p>Hi! I'm {{$profileData->name}} the Stuff of Information Technology in KIOT.</p>
        <div class="mt-3">
  ...
  <div class="col-md-8 col-xl-8 middle-wrapper">
    ...
    <div class="card">
              <div class="card-body">
								...
								<h6 class="card-title">Update Stuff Profile</h6>

								<form class="forms-sample" method="POST" action="{{route('stuff.profile.store')}}" enctype='multipart/form-data'>
								@csrf	
                <div class="mb-3">
